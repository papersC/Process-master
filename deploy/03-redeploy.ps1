# =============================================================
# ejraa360 — preserve-config redeploy
#
# Run on the EC2 IIS host AS ADMINISTRATOR after copying the
# deploy ZIP to C:\Temp\ejraa360-App.zip via RDP.
#
...
#   - logs\                           (stdout history)
# Then clears C:\inetpub\ESEMS, extracts the ZIP, and restores the
# preserved files. Finishes with a smoke test against the bound
# host (NOT localhost — that falls through to Default Web Site).
# =============================================================
